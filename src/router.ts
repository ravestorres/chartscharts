...
// In your router.ts, add this temporarily:
{
  path: '/test-data',
  name: 'test.data',
...
{
  path: '/weekly/stats/album-bomb',
  name: 'weekly.stats.album_bomb',
  component: () => import('@/views/Stats/AlbumBombChart.vue'),
  meta: {
    title: 'Album Bomb Chart'
  }
},
...
//   // }
// },
// In router.ts - make sure it looks like this:
{
  path: '/artist/:artistName',  // Note: using :artistName, not :name
  name: 'artist.detail',
  component: () => import('./views/ArtistDetail.vue'),
  props: true,
},
