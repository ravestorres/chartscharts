            ...
            <b-col sm="12" md="6">
              <b-card class="mb-4 mt-3 shadow border-0 text-center"
                ...
                <b-card-text class="text-left">
                  View artists who debuted 3 or more songs in a single week.
                </b-card-text>
                <template #footer>
                  <b-button-group>
                    <b-button variant="danger" :to="{ name: 'weekly.stats.album_bomb' }">
                      <font-awesome-icon data-html2canvas-ignore="true" :icon="['fa', 'compact-disc']" /> 
                      Artist Bombs
                    </b-button>
                  </b-button-group>
                </template>
...
export default class WeekStats extends Vue {
  get user() {
